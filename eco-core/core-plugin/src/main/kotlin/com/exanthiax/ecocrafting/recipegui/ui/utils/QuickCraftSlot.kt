...
import com.exanthiax.ecocrafting.quickcraft.service.CraftAttempt
...
fun resolveFailureMessage(plugin: com.exanthiax.ecocrafting.EcoCraftingPlugin, failure: CraftFailure): String? = when (failure) {

...
object RecipeCapEnforcer {
    ...
    /**
     * Returns true if [id] of [type] may register given [freeVersion]. Re-checking an
     * already-registered [id] (e.g. on config reload) always succeeds without consuming
     * another slot.
     */

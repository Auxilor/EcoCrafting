package io.auxilor.ecocrafting.recipegui.ui
...
import io.auxilor.ecocrafting.recipegui.ui.utils.RecipeGUIContext
import io.auxilor.ecocrafting.recipegui.ui.utils.buildBackSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildFuelSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildIndicatorSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildIngredientSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildQuickCraftSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildVariantSlot
import io.auxilor.ecocrafting.recipegui.ui.utils.buildWorkstationSlot
...
class RecipeGUI(
    private val services: RecipeGuiServices,
    val stack: ItemStack,
    ...
    fun open(player: Player, parent: Menu?) {
        ...
        val recipe = (effectiveAlternatives.getOrNull(altIndex)
            ...
            ?: run {
                ...
                return
            }).withLockState(player, services.recipeService, services.unlockService)
